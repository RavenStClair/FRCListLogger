...
public class PathInterpolator {
    ...
    **/
    public static void setFile(String fileName) {
        ...
        System.out.print("raw_l = ");
        FileReader.scanToList(fileName, raw_l, 1);
        System.out.print("raw_t = ");
        FileReader.scanToList(fileName, raw_t, 2);
    ...
    /**
     * 
     * @param time - time value. If we want to speed up or slow down the program, we can multiply/divide the actual time.
     * @return - double[] array containing right and left encoder values robot should be at at that instant
     * @throws Exception
     */

    public static double[] calcPositions(float time) throws Exception {
